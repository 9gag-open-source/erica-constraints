...
#define STRETCH_PARTIAL_H(VIEW, PERCENT) INSTALL_CONSTRAINTS(DEFAULT_LAYOUT_PRIORITY, @"Stretched View", CONSTRAINT_STRETCHING_PARTIAL_H(VIEW, PERCENT))
#define STRETCH_PARTIAL_V(VIEW, PERCENT) INSTALL_CONSTRAINTS(DEFAULT_LAYOUT_PRIORITY, @"Stretched View", CONSTRAINT_STRETCHING_PARTIAL_V(VIEW, PERCENT))
...
#define ALIGN_ALL(VIEW, INDENT)           {ALIGN_BOTTOM(VIEW, INDENT); ALIGN_LEFT(VIEW, INDENT); ALIGN_TOP(VIEW, INDENT); ALIGN_RIGHT(VIEW, INDENT);}
...
#define FOLLOW_H(VIEW1, OFFSET, VIEW2) INSTALL_CONSTRAINTS(DEFAULT_LAYOUT_PRIORITY, @"Create Row", CONSTRAINT_STACKING_H(VIEW1, VIEW2, OFFSET))
#define FOLLOW_V(VIEW1, OFFSET, VIEW2) INSTALL_CONSTRAINTS(DEFAULT_LAYOUT_PRIORITY, @"Create Column", CONSTRAINT_STACKING_V(VIEW1, VIEW2, OFFSET))
